...
(defn anim-fwd [hlq start-face]
  (let [hlq-str (name hlq)]
    ...
    (condp = start-face
      0 (.start (-> main-scene/scene (.getAnimationGroupByName (str hlq-str "-" "rotorAction.0-1"))))
      1 (.start (-> main-scene/scene (.getAnimationGroupByName (str hlq-str "-" "rotorAction.1-2"))))
      2 (.start (-> main-scene/scene (.getAnimationGroupByName (str hlq-str "-" "rotorAction.2-3"))))
      3 (.play (-> main-scene/scene (.getAnimationGroupByName (str hlq-str "-" "rotorAction.3-4"))))
      4 (.start (-> main-scene/scene (.getAnimationGroupByName (str hlq-str "-" "rotorAction.4-5"))))
      5 (.start (-> main-scene/scene (.getAnimationGroupByName (str hlq-str "-" "rotorAction.5-6"))))
      6 (.start (-> main-scene/scene (.getAnimationGroupByName (str hlq-str "-" "rotorAction.6-7"))))
      7 (.start (-> main-scene/scene (.getAnimationGroupByName (str hlq-str "-" "rotorAction.7-0")))))))
