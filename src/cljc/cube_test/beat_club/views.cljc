...
(defn init-panel []
  ...
  [:div
    ...
    ; [:button.user-action {:on-click #(re-frame/dispatch [:cube-test.beat-club.events/load-model-2 "models/beat_club/" "nla_simp_fbx.fbx" "nla_simp_fbx"])} "load-model-2"]
    ; [:button.user-action {:on-click #(re-frame/dispatch [:cube-test.beat-club.events/load-model-2 "models/beat_club/" "nla_simp.glb" "mv_right_simp"])} "load-model-2"]
    [:button.user-action {:on-click #(re-frame/dispatch [:cube-test.beat-club.events/load-model-4 "models/beat_club/" "ybot@idle_grasp.glb" "idle_grasp"])} "load-model-4"]
    [:button.user-action {:on-click #(re-frame/dispatch [:cube-test.beat-club.events/load-model-fbx "models/beat_club/" "nla_simp_fbx.fbx" "nla_simp_fbx"])} "load-model-fbx"]
