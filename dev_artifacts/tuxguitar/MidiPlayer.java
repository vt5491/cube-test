...
public class MidiPlayer{
	...
	//vt add
	protected VTHook vtHook = VTHook.getInstance();
	//vt end
	...
	public void stop(boolean paused) {
		try {
			//vt add
			System.out.println("vt:MidiPlayer.stop: entered");
			if (vtHook.isRecording) {
				this.vtHook.stopRecording();
			}
			//vt end
			this.lock();
